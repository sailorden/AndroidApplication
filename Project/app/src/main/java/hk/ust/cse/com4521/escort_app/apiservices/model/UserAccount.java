...
public class UserAccount {
    ...
    @Expose
    private List<Integer> escortPreferLocationDistrict = new ArrayList<Integer>();
     ...
     */
    public List<Integer> getEscortPreferLocationDistrict() {
     ...
     * The escortPreferLocationDistrict
     */
    public void setEscortPreferLocationDistrict(List<Integer> escortPreferLocationDistrict) {
